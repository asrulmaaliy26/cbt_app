        ...
        <section class="content">
            <div class="container-fluid">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm">
                                        ...
                                        <tr>
                                            <th>Prodi</th>
                                            <td>:
                                                <?= getDataRow('histori_pddk', ['id_his_pdk' => $id_his_pdk])['Prodi'] ?>
                                                -
                                                <?= getDataRow('histori_pddk', ['id_his_pdk' => $id_his_pdk])['Program'] ?>
                                                -
                                                <?= getDataRow('histori_pddk', ['id_his_pdk' => $id_his_pdk])['Kelas'] ?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th>Tgl. Upload</th>
                                            <td>:
                                                <?= ($ujian == 'uas') ? tgl_indonesia($tgl_upload_ljk_uas) : tgl_indonesia($tgl_upload_ljk_uts) ?>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm">
                                        <tr>
                                            ...
                                            <td>: <?= ($ujian == 'uas') ? 'UJIAN AKHIR SEMESTER' : 'UJIAN TENGAH SEMESTER' ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Mata Kuliah</th>
                                            <td>:
                                                <?= getDataRow('master_matakuliah', ['kode_mk' => $kode_mk_feeder])['nama_mk'] ?>
                                            </td>
                                        </tr>
                ...
                <?php if ($jns_soal == '1') { ?>
                    ...
                    <?php $dt_artikel = ($ujian == 'uas') ? getDataRow('tugas_artikel', ['id_artikel' => $artikel]) : getDataRow('tugas_artikel', ['id_artikel' => $artikel_uts]); ?>
                    <div class="card card-primary">
                        <div class="card-header">
                            Judul Artikel
                        </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <?= $dt_artikel['sistematika'] ?>
                        </div>
                    </div>
                    <div class="card card-primary card-outline">

                        <div class="card-body">
                            <iframe src="<?= str_replace('http://', 'https://', $dt_artikel['file_artikel']) ?>"
