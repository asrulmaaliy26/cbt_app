                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <?php
                                echo cmb_dinamis('pelaksanaan', 'ref_option', 'opt_val', 'opt_id', null, null, 'id="pelaksanaan" onchange="reload_table()" style="width:100%;"', null, null, ['opt_group' => 'pelaksanaan_kuliah']);
                                ?>
                            </div>
                        </div>
                    </div>
        ...
        table = $('#data').DataTable({
            ...
            "ajax": {
                ...
                "data": function(data) {
                    ...
                    data.pelaksanaan = $('#pelaksanaan').val();
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        type: "post",
                        data: {
                            id_distribusi_mk: list,
                            dosen: dosen,
                            H_Jadwal: H_Jadwal,
                            jam: jam,
                            ruang_kuliah: ruang_kuliah,
                            pelaksanaan_kuliah: pelaksanaan_kuliah
                        },
                        dataType: 'json',
                        beforeSend: function() {
                            Swal.fire({
