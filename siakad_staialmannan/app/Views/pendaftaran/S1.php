    ...
    <div class="content">
      <div class="container">
        <div class="row">
                ...
                <form class="form-horizontal" id="form_pendaftaran" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 pr-2">
                                            <div class="form-group">
												...
												<select id="kelas_program" name="kelas_program" class="form-control select2" data-placeholder="Klik Pilihan..." style="width:100%;" onchange="changeKelasProgram()">
													<option >  </option>
													<option value="Reguler">Reguler</option>
													<option value="Beasiswa Pesantren">Beasiswa Pesantren</option>
											...
											<div class="form-group">
												...
												<select  id="prodi1" name="prodi1" class="form-control select2" data-placeholder="Klik Pilihan..." style="width:100%;">
												    <!--
														<option >  </option>
														<option value="HKI">Hukum Keluarga Islam (HKI)</option>
														<option value="ES">Ekonomi Syari'ah (ES)</option>
														<option value="PBA">Pendidikan Bahasa Arab (PBA)</option>
														<option value="MPI">Manajemen Pendidikan Islam (MPI)</option>
														<option value="PGMI">Pendidikan Guru MI (PGMI)</option>
														<option value="IAT">Ilmu Al-Qur'an dan Tafsir (IAT)</option>
														<option value="ILHA">Ilmu Hadits (ILHA)</option>
													-->
												</select>
												<div class="invalid-feedback"></div>
											</div>
											<?php }else{ ?>
											    <input type="text" class="form-control"  id="prodi1" name="prodi1" value="<?=$prodi;?>" hidden/>
											<?php } ?>
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h5 class="card-title"><b>DATA ASAL SEKOLAH</b></h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6 pr-2">
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label">Jenis Asal Sekolah<code>*</code></label>
                                                    <select name="Jenis_SLTA" id="Jenis_SLTA" class="form-control select2" style="width:100%;">
                                                        <<option value="">  </option>
                                        ...
                                        <div class="col-sm-6 pl-2">
                                            <div class="form-group">
            					                <label for="asal_sekolah">Alamat Lengkap Sekolah Asal <code>*</code></label>
            ...
            <div class="col-lg-4">
                <?php if(!empty(getDataRow('setting_gelombang', ['jenjang' => 'S1', 'Aktif' => '1'])['info_pendaftaran'])){ ?>
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                    <?=getDataRow('setting_gelombang', ['jenjang' => 'S1', 'Aktif' => '1'])['info_pendaftaran']?>
                  </div>
                  <!-- /.card-body -->
                </div>
                <?php } ?>
                <?php if(!empty(getDataRow('setting_gelombang', ['jenjang' => 'S1', 'Aktif' => '1'])['info_biaya_kuliah'])){ ?>
                <div class="card card-primary">
                  <div class="card-header">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                    <?=getDataRow('setting_gelombang', ['jenjang' => 'S1', 'Aktif' => '1'])['info_biaya_kuliah']?>
                  </div>
                  <!-- /.card-body -->
                </div>
                <?php } ?>
                <?php if(!empty(getDataRow('setting_gelombang', ['jenjang' => 'S1', 'Aktif' => '1'])['persyaratan'])){ ?>
                <div class="card card-primary">
                  <div class="card-header">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                    <?=getDataRow('setting_gelombang', ['jenjang' => 'S1', 'Aktif' => '1'])['persyaratan']?>
                  </div>
                  <!-- /.card-body -->
                </div>
                <?php } ?>
...
function changeKelasProgram(){
    let kelas_program = $('#kelas_program option:selected').val();
    if(kelas_program == 'Madin'){
        var prodi = [{ id: '', text: '--Pilih Prodi--' },{ id: 'PBA', text: 'Pendidikan Bahasa Arab (PBA)' }];
        
        $("#prodi1").select2('destroy').empty().select2({
          data: prodi
        })
        
    }/*else if(jenjang == 'MTs/SMP'){
        var kelas = [{ id: '', text: '--Pilih Opsi--' },{ id: '2A', text: '2A' }, { id: '3A', text: '3A' }, { id: '4', text: '4' }];
        
        $("#kelas_pendaftaran").select2('destroy').empty().select2({
          data: kelas
        })
        
    }*/else{
        var prodi = [{ id: '', text: '--Pilih Prodi--' },{ id: 'SI', text: 'Studi Islam (SI)' }, { id: 'MPI', text: 'Manajemen Pendidikan Islam (MPI)' }, { id: 'IAT', text: 'Ilmu Al-Qur`an dan Tafsir (IAT)' }];
